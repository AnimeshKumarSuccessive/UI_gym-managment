...
const handleSubmit = (e) => {
    console.log('id', id);
	e.preventDefault();
	axios.put(`http://localhost:3090/user/${id}`, {
...
const successMessage = () => {
	...
	<div
		...
		<h1>{name} has successfully registered as a user!!</h1>
	</div>
	);
};
...
return (
	...
	<div className="messages">
		...
		<Link className='nav-link' style={{color:'blue', padding:'10px'}} to='/user/delete'>
            DELETE
		</Link>
	</div>
);
