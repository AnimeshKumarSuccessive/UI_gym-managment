...
const handleSubmit = (e) => {
	e.preventDefault();
	axios.post('http://localhost:3090/trainner', {
...
const successMessage = () => {
	...
	<div
		...
		<h1>{name} has successfully registered as a Trainner!!</h1>
	</div>
	);
};
...
return (
	...
	<br />
	<Link className='nav-link' style={{color:'blue', padding:'10px'}} to='/trainner/update'>
		UPDATE
	</Link>
